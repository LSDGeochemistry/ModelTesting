...
dem = gdal.Open(fname)
print('loaded dem')
#Read in the coordinates, needs changed for whatever files being read
...
pits = np.loadtxt("C:/Workspace/github/ModelTesting/pomd_sites.txt",delimiter=',',skiprows=1,usecols=(2,3))
...
center_point = [[645390.5,4389697.5]]
