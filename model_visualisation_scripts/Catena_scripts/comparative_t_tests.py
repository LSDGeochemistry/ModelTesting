...
# DataDirectory = '/exports/csce/datastore/geos/users/s0933963/github/LSDMixingModel/Runs/changing_base_level/0_1mm_nonlinear/0mm_mixing/'
DataDirectory2 = '/exports/csce/datastore/geos/users/s0933963/github/LSDMixingModel/Runs/changing_base_level/0_1mm_linear/10mm_mixing/'

print('This is the input file directory: '+DataDirectory2)
bins2 = pd.read_csv(DataDirectory2+'ep_trans_out.pout', sep=" ",names=['time', 'bn', 'pid','z_loc','s_loc','d_loc','buff','page','osl','be_conc','c_conc','ne_conc'] )
print('loaded the particle file')
...
for i in range(0,len(time_unique)):
    ...
    temp_bins2=bins2[(bins2['time'] == time_unique[i]) & (bins2['bn'] == bins2.bn.max())]
    # print(time_unique[i])
