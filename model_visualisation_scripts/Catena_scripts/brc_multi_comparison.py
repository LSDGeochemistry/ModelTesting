...
#Import the data_
DataDirectory = '/exports/csce/datastore/geos/users/s0933963/github/LSDMixingModel/Runs/feather_runs/brc/linear_ss/'
...
# plt.show()
# plt.tight_layout()
plt.savefig(DataDirectory+'brc_crn_pits_combined.png', dpi=100, bbox_inches='tight')
