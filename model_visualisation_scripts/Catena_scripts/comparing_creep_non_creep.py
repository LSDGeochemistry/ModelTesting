...
#Import the data_
DataFolder = '/exports/csce/datastore/geos/users/s0933963/github/LSDMixingModel/Runs/sensitivity_tests/production/'
w=0
...
ax.legend(loc='upper left',title='Test',fontsize=12,markerscale=12)
ax.axvline(24000)
ax.set_xlim(0,35000)
plt.savefig(DataFolder+'/creep_vs_non_creep.png', dpi=100, bbox_inches='tight')
