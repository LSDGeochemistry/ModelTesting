...
DataDirectory = '/exports/csce/datastore/geos/users/s0933963/github/LSDMixingModel/Runs/changing_base_level/0_1mm_nonlinear/1mm_mixing'
...
for i in range(0,timesteps):
    ...
    ax.scatter(ds_dist,elev,s=2,c=colors[i])
        # ax.set_ylim(0,1.0)
...
for i in range(0,timesteps):
    ...
    ax.scatter(ds_dist,thick,s=2,c=colors[i])
...
plt.savefig(DataDirectory+'/hillslope_soil_profiles_with_time.png', dpi=100, bbox_inches='tight')
