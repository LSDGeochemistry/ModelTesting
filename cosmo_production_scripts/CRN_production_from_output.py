...
data2 = np.genfromtxt('C:/Workspace/github/LSDMixingModel/Runs/pomd/p_trans_out.pout', delimiter=' ',skip_header=0, names=['time', 'bn', 'pid','z_loc','s_loc','d_loc','buff','page','osl','be_conc','c_conc','ne_conc'])
